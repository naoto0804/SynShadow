...
from models.networks.base.sync_batchnorm import SynchronizedBatchNorm2d
...
def get_nonspade_norm_layer(opt, norm_type='instance'):
    ...
    def add_norm_layer(layer):
        ...
        elif subnorm_type == 'adaptive':
            norm_layer = AdaptiveNorm2d(get_out_channel(layer))
        else:
            raise ValueError(
...
# Fast Image Processing with Fully-Convolutional Networks (ICCV'17)
